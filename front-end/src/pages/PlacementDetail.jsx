  ...
  if (loading) {
    return (
      <div className="mx-auto mt-8 max-w-6xl px-4 pb-12 sm:px-6 lg:px-8">
        <div className="h-[520px] animate-pulse rounded-2xl border border-slate-200 bg-slate-50 dark:border-[#045C9A]/25 dark:bg-[#0d3a5f]" />
      </div>
    );
  }
  ...
  if (!job) {
    return (
      <div className="mx-auto mt-8 max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        <div className="flex min-h-[280px] flex-col items-center justify-center rounded-2xl border border-[#d7ebf5] bg-white p-8 text-center shadow-[0_2px_16px_rgba(26,56,132,0.07)] dark:border-[#045C9A]/20 dark:bg-[#0d3a5f]">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-[#EAF7FD] dark:bg-[#045C9A]/15">
            <Briefcase className="h-6 w-6 text-[#045C9A] dark:text-[#A6D7E8]" stroke={1.7} />
          </div>
          <h1 className="text-base font-semibold text-[#072036] dark:text-white">{t("placement.job_not_found", "Job not found")}</h1>
    ...
    <div className="relative min-h-screen overflow-hidden bg-transparent pb-12 transition-colors duration-300">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pt-4 sm:px-5 sm:pt-5 lg:px-6 lg:pt-6">
        ...
        <motion.div
          ...
          className="overflow-hidden rounded-2xl border border-[#d7ebf5] bg-white shadow-[0_2px_16px_rgba(26,56,132,0.07)] dark:border-[#045C9A]/20 dark:bg-[#0d3a5f]"
        >
          <div className="border-b border-[#d7ebf5] p-6 dark:border-[#045C9A]/20">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              <div className="flex min-w-0 gap-4">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-slate-50 text-lg font-semibold text-[#045C9A] dark:border-[#045C9A]/25 dark:bg-[#0d3a5f] dark:text-[#A6D7E8]">
                  {companyLogo ? (
                ...
                <div className="min-w-0">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#045C9A] dark:text-[#A6D7E8]">
                    {job.displayCompany}
                  </p>
                  <h1 className="mt-1 text-[22px] font-semibold leading-tight tracking-[-0.02em] text-[#072036] dark:text-white sm:text-[26px]">
                    {job.displayTitle}
                  </h1>
                    ...
                    <>
                      ...
                      {withdrewConfirmOpen && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
                          <div className="w-full max-w-sm rounded-xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-[#045C9A]/30 dark:bg-[#0d3a5f]">
                            <h3 className="text-[16px] font-semibold tracking-[-0.01em] text-[#072036] dark:text-white">{t("placement.confirm_withdraw", "Confirm withdraw")}</h3>
                            ...
                            <div className="mt-6 flex justify-end gap-2.5">
                              <button onClick={() => setWithdrewConfirmOpen(false)} className="h-9 rounded-lg border border-slate-200 px-4 text-[13px] font-medium text-slate-600 transition-colors hover:bg-slate-50 dark:border-[#045C9A]/30 dark:text-slate-300 dark:hover:bg-[#0d3a5f]">{t("placement.cancel", "Cancel")}</button>
                              <button
                                onClick={async () => {
            ...
            <div className="mx-6 mt-6 rounded-xl border border-sky-200 bg-sky-50/70 p-5 dark:border-sky-500/25 dark:bg-sky-500/[0.07]">
                <div className="flex flex-col justify-between gap-6 md:flex-row md:items-start">
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-4 flex flex-col gap-6 rounded-lg border border-sky-100 bg-white p-4 dark:border-sky-500/20 dark:bg-[#0d3a5f] sm:flex-row">
                            <div>
                                <p className="mb-1 text-[10.5px] font-medium uppercase tracking-[0.07em] text-slate-400">Package Offered</p>
                                <p className="text-[15px] font-semibold text-[#072036] dark:text-white">{applicationData.offeredPackage || 'Not specified'}</p>
                            </div>
                            <div>
                                <p className="mb-1 text-[10.5px] font-medium uppercase tracking-[0.07em] text-slate-400">Offer Date</p>
                                <p className="text-[15px] font-semibold text-[#072036] dark:text-white">
                    ...
                    <div className="flex w-full flex-col gap-3 md:w-[260px] md:flex-shrink-0">
                        <div>
                            ...
                            <input
                                ...
                                className="h-10 w-full rounded-lg border border-sky-200 bg-white px-3.5 text-[13.5px] text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-sky-500 focus:ring-[3px] focus:ring-sky-500/10 dark:border-sky-500/25 dark:bg-[#0d3a5f] dark:text-white"
                            />
                        </div>
          ...
          <div className="grid gap-6 p-6 lg:grid-cols-[1.3fr_0.7fr] lg:items-start">
            <section className="space-y-7">
              ...
              {getBenefits(job) && (
                <div>
                  <h2 className="flex items-center gap-2 text-[15px] font-semibold tracking-[-0.01em] text-[#072036] dark:text-white">
                    <Gift stroke={1.7} className="h-[18px] w-[18px] text-[#045C9A] dark:text-[#A6D7E8]" />
              ...
              {eligibility && (
                <div>
                  <h2 className="flex items-center gap-2 text-[15px] font-semibold tracking-[-0.01em] text-[#072036] dark:text-white">
                    <ShieldCheck stroke={1.7} className="h-[18px] w-[18px] text-[#045C9A] dark:text-[#A6D7E8]" />
                    ...
                    <div className="grid grid-cols-1 gap-x-5 gap-y-4 sm:grid-cols-2">
                      {eligibility.map(({ label, value, icon: Icon, fullWidth }) => (
                        <div key={label} className={`flex items-start gap-3 ${fullWidth ? 'sm:col-span-2' : ''}`}>
                          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white dark:border-[#045C9A]/30 dark:bg-[#0d3a5f]">
                            <Icon stroke={1.7} className="h-[17px] w-[17px] text-[#045C9A] dark:text-[#A6D7E8]" />
                          </div>
                          <div className="flex min-w-0 flex-col pt-[2px]">
                            ...
                            <p className="mt-0.5 break-words text-[13.5px] font-semibold leading-tight text-[#072036] dark:text-white">{formatValue(value, t)}</p>
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              {Array.isArray(job.projectDomains) && job.projectDomains.length > 0 && (
                <div>
                  <h2 className="flex items-center gap-2 text-[15px] font-semibold tracking-[-0.01em] text-[#072036] dark:text-white">
                    <Briefcase stroke={1.7} className="h-[18px] w-[18px] text-[#045C9A] dark:text-[#A6D7E8]" />
                  ...
                  <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50/70 p-5 dark:border-[#045C9A]/25 dark:bg-[#0d3a5f]">
                    <div className="flex flex-wrap gap-2">
                      {job.projectDomains.map((d, i) => (
                        <span
                          key={i}
                          className="inline-flex items-center rounded-lg border border-[#045C9A]/15 bg-white px-3 py-1.5 text-[12.5px] font-semibold text-[#045C9A] dark:border-[#A6D7E8]/25 dark:bg-[#0d3a5f] dark:text-[#A6D7E8]"
                        >
                          {d}
                        </span>
                      ))}
                  ...
                  <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50/70 p-5 dark:border-[#045C9A]/25 dark:bg-[#0d3a5f]">
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                      {job.courseSkills.map((c, i) => (
                        <div key={c._id || i} className="flex items-center gap-3 rounded-lg border border-slate-200 bg-white px-3 py-2.5 dark:border-[#045C9A]/30 dark:bg-[#0d3a5f]">
                          <div className="min-w-0">
            ...
            <aside className="space-y-6 lg:sticky lg:top-6">
              ...
              {skills.length > 0 && (
                <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-5 dark:border-[#045C9A]/25 dark:bg-[#0d3a5f]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {skills.map((skill) => (
                      <span key={skill} className="rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-[12.5px] font-medium text-[#072036] dark:border-[#045C9A]/30 dark:bg-[#0d3a5f] dark:text-slate-200">
                        {skill}
                      </span>
                    ))}
                  </div>
      ...
      <Dialog open={applyOpen} onOpenChange={setApplyOpen}>
        <DialogContent className="sm:left-[calc(50%+128px)] w-[92%] sm:w-full max-h-[92vh] max-w-2xl overflow-y-auto rounded-2xl border-[#d7ebf5] bg-white p-0 dark:border-[#045C9A]/20 dark:bg-[#0d3a5f]">
          <DialogHeader className="border-b border-[#d7ebf5] px-6 py-5 text-left dark:border-[#045C9A]/20">
            <DialogTitle className="text-[17px] font-semibold tracking-[-0.01em] text-[#072036] dark:text-white">
            ...
            <DialogDescription className="text-[13px] text-slate-500 dark:text-slate-400">
              <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                ...
                <span>{job.displayLocation}</span>
                {/* Source badge */}
                <span className="ml-1 inline-flex items-center rounded-md bg-[#EAF7FD] px-2 py-[3px] text-[10.5px] font-medium text-[#045C9A] dark:bg-[#045C9A]/20 dark:text-[#A6D7E8]">
          ...
          <form onSubmit={handleApplicationSubmit} className="space-y-5 px-6 py-5">
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="space-y-1.5">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-slate-200 bg-white px-3.5 text-[13.5px] text-slate-900 outline-none transition-all focus:border-[#045C9A] focus:ring-[3px] focus:ring-[#045C9A]/10 dark:border-[#045C9A]/30 dark:bg-[#0d3a5f] dark:text-white"
                />
              </label>
              ...
              <label className="space-y-1.5">
                ...
                <div className="relative">
                    <input
                      ...
                      className={`h-10 w-full rounded-lg border border-slate-200 px-3.5 text-[13.5px] text-slate-900 outline-none transition-all focus:border-[#045C9A] focus:ring-[3px] focus:ring-[#045C9A]/10 dark:border-[#045C9A]/30 dark:bg-[#0d3a5f] dark:text-white ${isBacklogReadOnly ? 'cursor-not-allowed border-emerald-200 bg-emerald-50/60 text-emerald-800 dark:border-emerald-800/50 dark:bg-emerald-900/10 dark:text-emerald-300' : 'bg-white'}`}
              ...
              <div className="space-y-1.5 sm:col-span-2">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-[12px] font-medium text-[#045C9A] transition-colors hover:underline dark:text-[#A6D7E8]"
                  >
                ...
                {showCoverExample && (
                  <div className="whitespace-pre-wrap rounded-lg border border-[#d7ebf5] bg-[#EAF7FD] p-4 text-[12.5px] leading-relaxed text-slate-600 dark:border-[#045C9A]/25 dark:bg-[#0d3a5f] dark:text-slate-300">
                    {exampleCoverLetter}
                  </div>
                )}
                ...
                <textarea
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 text-[13.5px] leading-relaxed text-slate-900 outline-none transition-all focus:border-[#045C9A] focus:ring-[3px] focus:ring-[#045C9A]/10 dark:border-[#045C9A]/30 dark:bg-[#0d3a5f] dark:text-white"
                />
            ...
            {applyUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 text-[13px] font-medium text-[#045C9A] transition-colors hover:underline dark:text-[#A6D7E8]"
              >
            ...
            <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50/70 p-4 dark:border-[#045C9A]/25 dark:bg-[#0d3a5f]">
              <label className="inline-flex cursor-pointer items-start gap-3 text-left">
                <input
                  type="checkbox"
                  required
                  className="mt-0.5 h-4 w-4 shrink-0 rounded border-slate-300 text-[#045C9A] focus:ring-[#045C9A] dark:border-[#045C9A]/40 dark:bg-[#0d3a5f] dark:checked:bg-[#045C9A]"
                />
            ...
            <DialogFooter className="mt-5 gap-2 border-t border-[#d7ebf5] pt-5 dark:border-[#045C9A]/20 sm:gap-2">
              <button
                type="button"
                onClick={() => setApplyOpen(false)}
                className="h-9 rounded-lg border border-slate-200 px-4 text-[13px] font-medium text-slate-600 transition-colors hover:bg-slate-50 dark:border-[#045C9A]/30 dark:text-slate-300 dark:hover:bg-[#0d3a5f]"
              >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="h-9 rounded-lg bg-[#0E2136] px-5 text-[13px] font-medium text-white transition-colors hover:bg-[#1b3457] disabled:cursor-not-allowed disabled:opacity-60 dark:bg-[#A6D7E8] dark:text-[#072036] dark:hover:bg-white"
              >
      ...
      <Dialog open={termsOpen} onOpenChange={setTermsOpen}>
        <DialogContent className="sm:left-[calc(50%+128px)] w-[92%] sm:w-full max-w-md rounded-2xl border border-[#d7ebf5] bg-white p-6 dark:border-[#045C9A]/20 dark:bg-[#0d3a5f]">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-[16px] font-semibold tracking-[-0.01em] text-[#072036] dark:text-white">
              <ShieldCheck className="h-[18px] w-[18px] text-[#045C9A] dark:text-[#A6D7E8]" stroke={1.7} />
          ...
          <DialogFooter className="mt-6 flex justify-end gap-2 border-t border-[#d7ebf5] pt-4 dark:border-[#045C9A]/20">
            <button
              type="button"
            ...
            <button
              ...
              className="h-9 rounded-lg bg-[#0E2136] px-5 text-[13px] font-medium text-white transition-colors hover:bg-[#1b3457] dark:bg-[#A6D7E8] dark:text-[#072036] dark:hover:bg-white"
            >
      ...
      {buildResumeOpen && (
        <div className="fixed inset-0 z-[100] flex flex-col bg-slate-900/50 backdrop-blur-sm sm:p-4">
          <div className="flex-1 w-full bg-[#F1F5F9] dark:bg-[#072036] sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col relative">
            <button 
