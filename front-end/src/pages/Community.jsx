      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-5">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            className="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#002147] hover:bg-slate-50 dark:hover:bg-[#1a3884]/20 text-slate-500 hover:text-[#1a3884] dark:hover:text-white transition-all shadow-sm hover:shadow active:scale-95 disabled:opacity-50 self-end md:self-center"
