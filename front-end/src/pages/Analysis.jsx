...
const Analysis = () => {
    ...
    return (
        <div className="min-h-screen bg-navy py-12 px-4 relative overflow-hidden selection:bg-teal/30 text-white font-sans">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 tracking-tight">
                        Your <span className="text-teal">Analysis Report</span>
                    </h1>
