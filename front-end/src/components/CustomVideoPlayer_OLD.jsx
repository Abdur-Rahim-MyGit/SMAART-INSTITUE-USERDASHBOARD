...
const CustomVideoPlayer = ({ videoUrl, title, duration, poster, initialMaxTime = 0, onProgressUpdate }) => {
         ...
         <AnimatePresence>
            {!isPlaying && !isLoading && (
               <motion.div 
                  ...
                  className="w-20 h-20 rounded-full bg-white shadow-xl flex items-center justify-center border-4 border-[#8B5CF6]"
               >
                  <Play className="w-10 h-10 fill-[#8B5CF6] ml-1" style={{ color: '#8B5CF6' }} />
               </motion.div>
            )}
         </AnimatePresence>
      </div>
          ...
          >
            ...
            <div className="relative group/scrubber mb-4">
               ...
               <div 
                  ...
                  style={{ left: `calc(${(currentTime / videoDuration) * 100}% - 8px)`, backgroundColor: '#8B5CF6' }}
               />
            </div>
            ...
            <div className="flex items-center justify-between gap-1 sm:gap-4">
               <div className="flex items-center gap-1 sm:gap-4">
                  {/* Play/Pause */}
                  <button onClick={togglePlay} className="hover:text-[#8B5CF6] transition-colors p-1" style={{ color: '#002147' }}>
                  ...
                  <div className="flex items-center gap-1 sm:gap-2 group/volume">
                     <button onClick={toggleMute} className="hover:text-[#8B5CF6] transition-colors p-1" style={{ color: '#002147' }}>
                     ...
                     <div className="w-0 group-hover/volume:w-20 overflow-hidden transition-all duration-300 flex items-center h-8">
                        <input
                           ...
                           className="w-full accent-[#8B5CF6] h-1"
                        />
                     </div>
                  </div>
               ...
               <div className="flex items-center gap-2 sm:gap-4">
                  ...
                  {/* Fullscreen */}
                  <button onClick={toggleFullscreen} className="hover:text-[#8B5CF6] transition-colors p-1.5 sm:p-1" style={{ color: '#002147' }}>
