    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
        <motion.div
          ...
          className="bg-white dark:bg-slate-800 rounded-none w-full max-w-md overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700"
        >
          {/* Header */}
          ...
          <div className="p-6 flex flex-col items-center">
            ...
            {/* QR Code Wrapper */}
            <div className="bg-white p-4 border-2 border-slate-100 dark:border-slate-700 shadow-sm mb-6 relative group">
              <QRCodeSVG 
            ...
            <div className="w-full space-y-3">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-2.5 px-4 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-sm font-bold flex items-center justify-center gap-2 transition-colors border border-slate-200 dark:border-slate-600"
                >
                  {copied ? (
                    <>
                ...
                <a
                  ...
                  className="flex-1 py-2.5 px-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-sm font-bold flex items-center justify-center gap-2 transition-colors border border-slate-200 dark:border-slate-600"
                >
