        ...
        >
            ...
            >
                ...
                <div className="relative px-6 pb-6 pt-10 sm:px-8">
                    <button
                        onClick={onClose}
                        className="absolute left-6 top-6 flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white/50 px-3 py-1.5 text-xs font-semibold text-slate-600 transition-all hover:bg-white dark:border-slate-700 dark:bg-slate-800/50 dark:text-slate-300 dark:hover:bg-slate-800"
                    >
                    ...
                    <button
                        onClick={onClose}
                        className="absolute right-6 top-6 rounded-full p-2 text-slate-400 transition-all hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-slate-800 dark:hover:text-slate-300"
                    >
                        <X className="h-5 w-5" />
                    </button>
                    ...
                    <div className="mt-8 text-center sm:mt-4">
                        ...
                        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                            ...
                            <button className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white/80 px-5 py-2.5 text-sm font-semibold text-slate-600 transition-all hover:bg-white dark:border-slate-700 dark:bg-slate-800/80 dark:text-slate-300 dark:hover:bg-slate-800">
                        ...
                        <div className="flex flex-col items-center border-b border-slate-200/80 px-6 py-8 dark:border-slate-700/80 lg:w-[45%] lg:border-b-0 lg:border-r">
                            <div className="relative mb-6 h-32 w-32 sm:h-36 sm:w-36">
                                ...
                                <img
                                    src={spImage}
                                    alt="SMAART AI"
                                    className="relative h-full w-full rounded-2xl border-2 border-white object-cover shadow-lg dark:border-slate-800"
                                    loading="lazy"
                                />
                            </div>
