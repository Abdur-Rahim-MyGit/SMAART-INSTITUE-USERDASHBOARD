    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
          <div className="relative flex-1 sm:flex-initial">
            ...
            <input 
              ...
              max={getTodayStr()}
              className="pl-9 pr-4 py-2 bg-[#F8FAFC] dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl outline-none focus:ring-2 focus:ring-[#1a3884]/20 focus:border-[#1a3884] text-sm font-semibold text-slate-800 dark:text-white cursor-pointer transition-all w-full"
            />
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="bg-white dark:bg-[#001630] p-4 sm:p-5 rounded-2xl border border-[#d8e6f7] shadow-[0_2px_16px_rgba(26,56,132,0.07)] dark:border-[#1a3884]/20 dark:shadow-[0_2px_16px_rgba(0,0,0,0.25)] flex flex-col justify-between hover:scale-[1.01] transition-transform duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-[#001630] p-4 sm:p-6 rounded-2xl border border-[#d8e6f7] shadow-[0_2px_16px_rgba(26,56,132,0.07)] dark:border-[#1a3884]/20 dark:shadow-[0_2px_16px_rgba(0,0,0,0.25)] flex flex-col justify-between">
          <div>
...
export const CollegeAnalyticsView = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#002A5C] p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 md:flex md:flex-wrap gap-3 sm:gap-4 w-full md:w-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white dark:bg-[#002A5C] p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-white/10">
          <div className="mb-6">
        ...
        {/* Progress Trend */}
        <div className="bg-white dark:bg-[#002A5C] p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-white/10">
          <div className="mb-6">
            <h3 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="bg-white dark:bg-[#002A5C] p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-white/10 flex items-center justify-between">
            <div>
