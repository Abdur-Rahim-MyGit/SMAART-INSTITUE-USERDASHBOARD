        ...
        <div className="p-5 sm:p-6 border-b border-[#d7ebf5] dark:border-white/5 bg-[#F1F5F9] dark:bg-transparent">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <h2 className="text-xl font-bold text-[#072036] dark:text-white leading-tight">{ticket.title}</h2>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 min-[400px]:grid-cols-3 gap-3">
            ...
            <div className="p-3.5 rounded-xl bg-[#F1F5F9] dark:bg-[#072036] border border-[#d7ebf5] dark:border-white/5">
              ...
              <span className="text-[#072036] dark:text-white text-[13.5px] font-bold">{categoryConfig.label}</span>
            </div>
            ...
            <div className="p-3.5 rounded-xl bg-[#F1F5F9] dark:bg-[#072036] border border-[#d7ebf5] dark:border-white/5">
              ...
              <span className="text-[#072036] dark:text-white text-[13.5px] font-bold truncate block">
          ...
          <div className="space-y-1.5">
            ...
            <div className="p-4 rounded-xl bg-[#F1F5F9] dark:bg-[#072036] border border-[#d7ebf5] dark:border-white/5">
              <p className="text-[#072036] dark:text-slate-200 text-sm whitespace-pre-wrap leading-relaxed">{ticket.description}</p>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-wrap items-center gap-2 mb-2">
                        <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ${itsm ? 'bg-[#045C9A]/10 text-[#045C9A] dark:bg-[#045C9A]/30 dark:text-[#A6D7E8]' : 'bg-slate-200 text-[#072036] dark:bg-[#045C9A]/30 dark:text-[#A6D7E8]'
                          }`}>
                          <span className="text-[10px] font-bold">
                            {getSenderInitial(response)}
                          </span>
                        </div>
                        <span className={`text-xs font-bold ${itsm ? 'text-[#045C9A] dark:text-[#A6D7E8]' : 'text-[#072036] dark:text-white'
                          }`}>
                          {getSenderName(response)}
                        </span>
                        {itsm && (
                          <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#045C9A]/10 text-[#045C9A] border border-[#045C9A]/20 dark:bg-[#045C9A]/30 dark:text-[#A6D7E8] dark:border-[#045C9A]/40 font-mono font-bold">ITSM</span>
                        )}
          ...
          {/* Admin Reply Section */}
          {isAdmin && (
            <div className="pt-4 border-t border-[#d7ebf5] dark:border-white/5 space-y-4">
                  ...
                  {Object.entries(STATUS_CONFIG).map(([key, config]) => (
                    <button
                      ...
                      className={`px-4 py-1.5 text-xs font-bold rounded-xl border transition-all ${selectedStatus === key
                        ? config.color
                        : 'border-[#d7ebf5] text-[#35566b] hover:border-slate-350 dark:border-[#045C9A]/30 dark:text-gray-400 dark:hover:border-[#045C9A]/50 bg-white dark:bg-transparent'
                        }`}
                    >
                      {config.label}
                    </button>
              ...
              <div className="relative">
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#072036] border border-[#d7ebf5] dark:border-white/10 text-[#072036] dark:text-white placeholder-slate-400 focus:border-[#045C9A] focus:outline-none transition-colors resize-none"
                />
                <button
                  onClick={handleSubmitReply}
