...
const BigFiveTest = lazy(() => import('@/pages/BigFiveTest'));
const VAKTest = lazy(() => import('@/pages/VAKTest'));
const EQTest = lazy(() => import('@/pages/EQTest'));
const CQTest = lazy(() => import('@/pages/CQTest'));
const ARQTest = lazy(() => import('@/pages/ARQTest'));
const AIQTest = lazy(() => import('@/pages/AIQTest'));
const SQTest = lazy(() => import('@/pages/SQTest'));
