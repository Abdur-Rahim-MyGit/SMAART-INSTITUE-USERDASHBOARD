    ...
    <div className="w-full max-w-md mx-auto space-y-4 sm:space-y-6">
      ...
      >
        ...
        <Button
          ...
          className="text-[#30919D] hover:text-[#267a84] hover:bg-[#30919D]/5 dark:hover:bg-white/5 shrink-0 text-xs font-bold uppercase tracking-widest px-3 border border-transparent hover:border-[#30919D]/20 h-9 rounded-lg"
        >
          Change
        </Button>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            <Label htmlFor="login-email" className="text-gray-700 dark:text-gray-300 text-xs font-bold uppercase tracking-widest pl-1">Email or Student ID</Label>
            <div className="relative group">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-[#30919D] transition-colors" aria-hidden="true" />
              <Input
                id="login-email"
                type="text"
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            <div className="flex justify-between items-center">
              <Label htmlFor="login-password" className="text-gray-700 dark:text-gray-300 text-xs font-bold uppercase tracking-widest pl-1">Security Key</Label>
              <button
                type="button"
                onClick={() => setShowForgotPassword(true)}
                className="text-[10px] uppercase tracking-widest font-bold text-[#30919D] hover:text-[#267a84] transition-colors focus:outline-none"
              >
                Forgot?
              </button>
            </div>
          ...
          <motion.div variants={itemVariants} className="pt-4">
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-[#30919D] to-[#267a84] hover:from-[#267a84] hover:to-[#30919D] text-white h-12 sm:h-13 text-base font-bold rounded-xl shadow-xl shadow-[#30919D]/20 hover:shadow-2xl hover:shadow-[#30919D]/30 hover:-translate-y-0.5 transition-all duration-300 group"
              disabled={isLoading}
