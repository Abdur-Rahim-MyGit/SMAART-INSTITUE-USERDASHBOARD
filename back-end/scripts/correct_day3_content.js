...
const correctDay3Content = async () => {
    try {
        ...
        console.log('Restructuring Day 3 steps...');

        // Get existing Step 5 content (which already has Q1, Q2, Q3)
        const existingStep5 = day3.steps.find(s => s.stepNumber === 5);

        // Reconstruct the steps array with correct structure
        day3.steps = [
            {
                stepNumber: 1,
                title: 'STEP 1 — Mastering Critical Thinking',
                type: 'video',
                content: {
                    videoUrl: day3.videoUrl || day3.VideoContent?.[0]?.videoUrl || '',
                    title: 'Mastering Critical Thinking',
                    description: 'Learn the foundations of critical thinking and the CLEAR-5 framework.',
                    duration: day3.VideoContent?.[0]?.duration || 0,
                    transcription: day3.VideoContent?.[0]?.transcription || ''
                },
                isRequired: true
            },
            {
            ...
            {
                stepNumber: 5,
                title: 'STEP 7: Founder Congratulatory Video',
                type: 'video',
                content: {
                    videoUrl: 'https://example.com/founder-video.mp4', // Placeholder
                    title: 'Congratulations from the Founder',
                    description: 'A special message celebrating your progress.',
                    duration: 180
                },
                isRequired: false
            },
            {
                stepNumber: 6,
                title: 'STEP 8: Flash Card + Interview Prep',
                type: 'flashcard',
                content: {
            ...
            {
                stepNumber: 7,
                title: 'STEP 9: Post-Employment Application Trigger',
                type: 'reflection',
                content: {
        ...
        console.log('✅ Day 3 content successfully restructured!');
